...
class Goods extends BaseController
{
    ...
    /**
     * 创建时间：2015年6月1日09:40:10 创建人：万域网络
   ...
   /**
    ...
    /**
     * 创建时间：2015年5月28日11:19:30 创建人：万域网络
    ...
    /**
     * 创建时间：2015年6月10日15:25:14 创建人：万域网络
    ...
    /**
     * 创建时间：2015年6月1日17:17:53 创建人：万域网络
     * 功能说明：商品属性规格获取
     */
  ...
  /**
     * 创建时间：2015年6月12日09:50:07 创建人：万域网络
...
$product['goods_attribute_id'], $product['goods_attribute'], $product['goods_spec_format'], $product['goods_weight'], $product['goods_volume'], $product['shipping_fee_type'], $product['categoryExtendId'], $product["sku_picture_vlaues"],$product["group_price"],$product["group_num"]);
 ...
 public function goodsGroupList()
    ...
    public function updateGoodsGroup()
    {
        ...
        if (request()->isAjax()) {
            ...
            if(empty($result)||$result['shop_id']!= $this->instance_id)
            {
                $this->error("当前商品分组不存在或者用户无权限!");
            }
    ...
    public function getSearchGoodsList()
    {
        ...
        {
            $condition['goods_name'] = array('like','%'.$get_condition.'%' );
        }
       // $condition = isset($_POST['condition']) && $_POST['condition'] != '' ? (" goods_name like  '%{$_POST['condition']}%'") : " shop_id=";
        $goods_detail = new GoodsService();
 ...
 /**
  ...
  /**
    ...
    public function supplierList(){
        ...
        return view($this->style.'Goods/supplierList');
    }
    /**
     * 添加供货商
     * @return multitype:unknown
    ...
    public function addSupplier(){
        ...
        return view($this->style.'Goods/addSupplier');
    }
    /**
     * 修改代理商
     * @return multitype:unknown
    ...
    public function updateSupplier(){
        ...
        return view($this->style.'Goods/updateSupplier');
    }
    /**
     * 删除代理商
     * @return multitype:unknown
