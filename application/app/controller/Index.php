...
//             $v['price'] = str_replace('.00', '', $v['price']);
        ...
        //导航栏
        $goodscategorymodel = new GoodsCategory();   //导航的model
        $categorylist = $goodscategorymodel->getGoodsCategoryListByParentId(0);//导航栏
//            $categorylist = json_decode(json_encode($categorylist),true);
        $this->assign('categorylist', $categorylist);

//        $goodsmodel = new NsGoodsModel();//商品model
        $goodsservice = new Goods();
        $goodslist = $goodsservice->getGoodsList(1,3);//商品的列表
