...
interface IPromotion
{
    ...
    */
     ...
     */
    function updatePromotionFullMail($shop_id, $is_open, $full_mail_money);
    /**
     * 修改满减送活动审核状态
     * @param unknown $mansong_id
     * @param unknown $type
     */
    function setStatusPromotionMansong($mansong_id,$type);
    /**
     * 修改限时折扣状态
     * @param unknown $discount_id
     * @param unknown $type
     */
    function setStatusPromotionDiscount($discount_id,$type);
