...
interface IShop
{
    ...
    * @param unknown $type
    */
    function setStatus($shop_id, $type);
     ...
     * @param unknown $order
     */
    function getShopOrderReturnList($page_index, $page_size = 0, $condition = '', $order = '');
     ...
     * @param unknown $shop_type
     */
    function addPlatformShop($user_account,$user_pwd,$shop_name,$shop_group_id,$shop_type);
    /**
     * @param number $page_index
     * @param number $page_size
     * @param string $condition
     * @param string $order
     */
    function getGuideList($page_index = 1, $page_size = 0, $condition = '', $order = '');
    /**
     * 添加指南
     */
    function addGuide($title,$sort,$image,$content);
    
    /**
     * 修改指南
     */
    function updateGuide($guide_id,$title,$sort,$image,$content);
    /**
     * 获取详情
     * @param unknown $guide_id
     */
    function getGuideDetail($guide_id);
    /**
     * 线下店铺
     * @param unknown $shop_id
     ...
     */
    function updateShopOfflineStoreByshop($shop_id, $shop_vrcode_prefix, $live_store_name, $live_store_tel, $live_store_address, $live_store_bus,$latitude_longitude);
}
