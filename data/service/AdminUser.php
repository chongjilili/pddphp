...
class AdminUser extends User implements IAdmin
{
    ...
    public function getchildModuleQuery($moduleid)
    {
        ...
        $module_list = Session::get($module.'module_list_' . $moduleid);
        if (empty($module_list) || $module_list == false) {
            ...
            if (config('app_debug')) {
                Session::set($module.'module_list_' . $moduleid, $new_list);
                return $new_list;
            } else {
                $arrange_list = array();
                ...
                Session::set($module.'module_list_' . $moduleid, $arrange_list);
                return $arrange_list;
            }
        } else {
            return $module_list;
