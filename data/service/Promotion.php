...
class Promotion extends BaseService implements IPromotion
{
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\ICoupon::getCouponTypeList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\ICoupon::updateCouponType()
     */
    ...
    public function addPromotionMansong($mansong_name, $start_time, $end_time, $shop_id, $remark, $type, $range_type, $rule, $goods_id_array)
    {
        ...
        try {
            ...
            if(empty($operate_config->is_mansong_open)){
                $promot_mansong->rollback();
                return OPERATE_NO_OPEN;
            }
    ...
    public function addPromotiondiscount($discount_name, $start_time, $end_time, $remark, $goods_id_array)
    {
        ...
        try {
            ...
            $config = new Config();
            $operate_config = $config->getOperateConfig();
            if(empty($operate_config->is_discount_open)){
                $promotion_discount->rollback();
                return OPERATE_NO_OPEN;
            }
...
/**
 * (non-PHPdoc)
 * @see \data\api\IPromotion::closePromotionMansong()
 */
    ...
    /**
     * (non-PHPdoc)
     * @see \data\api\IPromotion::setStatusPromotionMansong()
     */
    
    public function setStatusPromotionMansong($mansong_id,$type){
        $promotion_mansong = new NsPromotionMansongModel();
        $retval = $promotion_mansong->save([
            'examine_status' => $type
        ], [
    ...
    public function setStatusPromotionDiscount($discount_id,$type){
        $promotion_mansong = new NsPromotionDiscountModel();
        $retval = $promotion_mansong->save([
            'examine_status' => $type
        ], [
            'discount_id' => $discount_id
