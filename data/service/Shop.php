    ...
    public function applyShopAccountWithdraw($shop_id, $bank_account_id, $cash)
    {
        ...
        if ($shop_account_obj["shop_balance"] >= $cash) {
            ...
            if ($shop_account_withdraw->id > 0) {
                ...
                $retval = $shop_account_service->addShopAccountWithdrawRecords(getSerialNo(), $shop_id, $cash, 2, $shop_account_withdraw->id, "店铺提现，扣除" . $shop_bank_account_info["realname"] . "余额" . $cash);
            }
