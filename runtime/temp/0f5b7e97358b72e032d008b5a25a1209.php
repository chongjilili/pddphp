...
<link type="text/css" rel="stylesheet" href="__TEMP__/<?php echo $style; ?>/public/css/group_buy.css">
			...
			<div class="classify-screen-con">
				<div class="classify-choose">
					<?php if($category_id == 0): ?>
						<a target="_self" href="SHOP_MAIN/<?php echo $path_info; ?>" class="selected" style="height: 45px;float: left;width:66px;"><span>全部</span></a>
					<?php else: ?>
						<a target="_self" href="SHOP_MAIN/<?php echo $path_info; ?>" style="height: 45px;float: left;width:66px;"><span>全部</span></a>
					<?php endif; if(is_array($goods_category_one) || $goods_category_one instanceof \think\Collection || $goods_category_one instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_category_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['category_id'] == $category_id): ?>
						<a target="_self" href="SHOP_MAIN/<?php echo $path_info; ?>?category_id=<?php echo $vo['category_id']; ?>" class="selected" title="<?php echo $vo['category_name']; ?>"><span><?php echo $vo['category_name']; ?></span></a>
						<?php else: ?>
						<a target="_self" href="SHOP_MAIN/<?php echo $path_info; ?>?category_id=<?php echo $vo['category_id']; ?>" title="<?php echo $vo['category_name']; ?>"><span><?php echo $vo['category_name']; ?></span></a>
...
<div class="main">
	<ul class="row-4">
		...
		<?php endif; if(is_array($discount_list) || $discount_list instanceof \think\Collection || $discount_list instanceof \think\Paginator): $i = 0; $__LIST__ = $discount_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<li>
			<a class="scope" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $vo['goods_id']; ?>" title="<?php echo $vo['goods_name']; ?>">
				<div class="p-img">
					<img alt="" src="__UPLOAD__/<?php echo $vo['picture']['pic_cover_big']; ?>">
...
<!-- 					</div> -->
					<div class="p-name">
						<span class="d-name"><strong><?php echo $vo['discount_name']; ?></strong></span>
						<span class="g-name"><?php echo $vo['goods_name']; ?></span>
					</div>
				</div>
				<div class="goods-price"><span class="sale">促销价<em>￥<?php echo $vo['promotion_price']; ?></em>元</span><span class="depreciate"><i class="fa fa-down"></i>直降：¥<?php echo $vo['price'] - $vo['promotion_price']; ?></span></div>
<!-- 				</div> -->
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_4969__=1;$__FOR_END_4969__=$page_count+1;for($i=$__FOR_START_4969__;$i < $__FOR_END_4969__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_12784__=1;$__FOR_END_12784__=$page_num+1;for($i=$__FOR_START_12784__;$i < $__FOR_END_12784__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_10803__=$page_count-$page_num+1;$__FOR_END_10803__=$page_count+1;for($i=$__FOR_START_10803__;$i < $__FOR_END_10803__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_7586__=$page-($page_num-1)/2;$__FOR_END_7586__=$page+($page_num-1)/2+1;for($i=$__FOR_START_7586__;$i < $__FOR_END_7586__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
