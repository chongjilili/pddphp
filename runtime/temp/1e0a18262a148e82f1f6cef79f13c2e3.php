<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"template/platform\Config\memberWithdrawSetting.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
...
<section class="panel panel-default">
	...
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-3">
					<input id="cash_min" type="number" min="0.00"  value="<?php echo $list['value']['withdraw_cash_min']; ?>" class="form-control"/><span class="withdraw_rule" id="verification_cash">提现金额不能为空</span>
	        ...
	        <div class="form-group">
				...
				<div class="col-md-3">
					<input id="multiple" type="number" min="0.00"  value="<?php echo $list['value']['withdraw_multiple']; ?>" class="form-control"/><span class="withdraw_rule" id="verification_multiple">提现倍数不能为空</span>
	...
	<!-- 		<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="poundage" type="number" min="0.00" step="0.01"  value="<?php echo $list['value']['withdraw_poundage']; ?>" class="form-control"/>&nbsp;%<span class="withdraw_rule" id="verification_poundage">提现手续费不能为空</span>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<textarea name="store_zy" rows="2" id="message" class="form-control" style="height:150px;" maxlength="50"><?php echo $list['value']['withdraw_message']; ?></textarea><span class="withdraw_rule" id="verification_message">提现提示信息不能为空</span>
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
