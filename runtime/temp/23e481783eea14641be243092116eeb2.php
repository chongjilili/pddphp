<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"template/platform\Goods\updateGoodsCategory.html";i:1500286956;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal" id="goods_category_form" name="form">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" class="form-control" id="category_name" value="<?php echo $data['category_name']; ?>" required>
				</div>
				...
				<div class="col-sm-2">
					<select id="pid" name="account" class="form-control m-b">
						...
						<?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): if( count($category_list)==0 ) : echo "" ;else: foreach($category_list as $key=>$v1): ?>
							<option value="<?php echo $v1['category_id']; ?>" <?php if($data['pid'] == $v1['category_id']): ?>selected<?php endif; ?>><?php echo $v1['category_name']; ?></option>
						<?php if(is_array($v1['child_list']) || $v1['child_list'] instanceof \think\Collection || $v1['child_list'] instanceof \think\Paginator): if( count($v1['child_list'])==0 ) : echo "" ;else: foreach($v1['child_list'] as $key=>$v2): ?>
							<option value="<?php echo $v2['category_id']; ?>" <?php if($data['pid'] == $v2['category_id']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $v2['category_name']; ?></option>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="short_name" name="short_name" required value="<?php echo $data['short_name']; ?>">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<select name="attr" id="attr_id" style="width:100%;height:30px;border-color:#d9d9d9;color:#555555;">
						...
						<option value="<?php echo $vo['attr_id']; ?>" <?php if($data['attr_id'] == $vo['attr_id']): ?>selected<?php endif; ?>><?php echo $vo['attr_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-4">
                      <label class="switch">
                          <input id="is_visible" type="checkbox" <?php if($data['is_visible'] == 1): ?>checked="checked"<?php endif; ?>>
                          <span></span> </label>
                  </div>
            </div>
            <div class="line line-dashed line-lg pull-in"></div>
			...
			<div class="form-group">
				...
				<div class="col-md-1">
					<input type="text" class="form-control" id="sort" value="<?php echo $data['sort']; ?>" number="true" min="0">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<p>
					    <?php if($data['category_pic'] == ''): ?> 
					    	<img id="imgLogo" src=""> 
						<?php else: ?>
		 				    <img id="imgLogo" src="__ROOT__/<?php echo $data['category_pic']; ?>" class="imglogo"/>
						<?php endif; ?> 
					</p>
	                                   		...
	                                   		<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;"> 
												...
												<input type="hidden" id="Logo" value="<?php echo $data['category_pic']; ?>" />
											 </span>
			...
			<div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div id="editor" class="form-control" style="overflow:scroll;height:150px;max-height:150px"><?php echo $data['description']; ?></div>
                                            </div>
                                        </div>
			<!-- 书签 -->
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<input id="category_id" type="hidden" value="<?php echo $data['category_id']; ?>">
