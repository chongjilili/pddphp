<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"template/platform\Shop\addPlatformShop.html";i:1503110755;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
								...
								<div class="col-md-4">
									<select id="shop_group_id" name="account"
										...
										<?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): if( count($group_list)==0 ) : echo "" ;else: foreach($group_list as $key=>$vg): ?>
											<option value="<?php echo $vg['shop_group_id']; ?>"><?php echo $vg['group_name']; ?></option>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
								...
								<div class="col-md-4">
									<select id="shop_type" name="account" class="form-control m-b">
										<?php if(is_array($type_list) || $type_list instanceof \think\Collection || $type_list instanceof \think\Paginator): if( count($type_list)==0 ) : echo "" ;else: foreach($type_list as $key=>$vt): ?>
											<option value="<?php echo $vt['instance_typeid']; ?>"><?php echo $vt['type_name']; ?></option>
										<?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
