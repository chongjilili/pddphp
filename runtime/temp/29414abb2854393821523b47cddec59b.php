<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform\Config\codeConfig.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal" id="wpay_form"  method="post">
			<div class="form-group">
				...
				<div class="col-md-4">
					<label class="switch">
						<input type="checkbox" id="platformCode" <?php if($code_config['platform'] == 1): ?>checked<?php endif; ?>>
						<span></span>
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<label class="switch">
						<input type="checkbox" id="adminCode" <?php if($code_config['admin'] == 1): ?>checked<?php endif; ?>>
						<span></span>
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<label class="switch">
						<input type="checkbox" id="pcCode" <?php if($code_config['pc'] == 1): ?>checked<?php endif; ?>>
						<span></span>
					</label>
				</div>
			</div>
