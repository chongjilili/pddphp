...
if(data !=null && data != ''){
	...
	if(data['adv_list'][0]['adv_image'] != ''){
		...
		$('.top-active-wrap').html('<a href="'+data['adv_list'][0]['adv_url']+'" target="_blank"><img src="__UPLOAD__/'+data['adv_list'][0]['adv_image']+'" style="width:'+width+'px;height:'+height+'px;"></a><a href="javascript:void(0);" title="关闭" class="top-active-close"></a>');
	}else{
	...
	success:function(data){
		...
		if(data != null && data !=""){
			if(data["user_info"]["nick_name"]!=null && data["user_info"]["nick_name"] != ""){
				...
				login_info_html+='<div class="login-message" style="line-height:27px;"><p class="message-title">Hi,我是<a href="SHOP_MAIN/member/index" class="member_name" title="'+data["user_info"]["nick_name"]+'">'+data["user_info"]["nick_name"]+'</a></p><p class="message-operation"><a href="javascript:logout();" class="logout" >退出</a></p></div>';
			}
		}else{
			...
			login_info_html += '<a href="SHOP_MAIN/login/registerbox" class="register">注册</a>';
...
<div class="right-sidebar NS-TEMPLATE-NAV-CONTAINER">
	...
	<div class="proclamation1">
		<ul class="mall-news">
			<?php if(is_array($new_article) || $new_article instanceof \think\Collection || $new_article instanceof \think\Paginator): $i = 0; $__LIST__ = $new_article;if( count($__LIST__)==0 ) : echo "暂时没有公告" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<li><a target="_blank" href="SHOP_MAIN/cms/articleclassinfo?article_id=<?php echo $vo['article_id']; ?>" title="><?php echo $vo['title']; ?>"><i></i><?php echo $vo['title']; ?></a></li>
			<?php endforeach; endif; else: echo "暂时没有公告" ;endif; ?>
		</ul>
	</div>
			
	<p class="right_title"><span>&nbsp;</span>管理</p>
	<div class="shortcut-menu">
		<a href="SHOP_MAIN/shop/applyindex" 
			title="申请商家入驻；已提交申请，可查看当前审核状态。" class="store-join-btn" target="_blank">商家加盟</a>
		<a href="ADMIN_MAIN/login" target="_blank" class="store-join-help">
			登录商家管理中心</a>
	</div>
</div>  <!--滚动图右侧公告-->
	</div>
	...
	<div class="seckill-channel" id="h-seckill">
		...
		<article class="main" id="discount">
			<ul>
				...
				<li onclick="location.href='SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $vo['goods_id']; ?>';">
...
<div class="w1210 store-wall2">
	<h2>
		<a class="store-wall-title" href="SHOP_MAIN/shop/shopstreet" title="店铺街" style="color: #000000">店铺街</a>
	</h2>
	<div class="store-con2">
		...
		<ul class="store-wall2-list">
			<?php $__FOR_START_15264__=0;$__FOR_END_15264__=18;for($i=$__FOR_START_15264__;$i < $__FOR_END_15264__;$i+=1){ ?>
				<li>
				<?php if($i < $shop_list_count): if($shop_list[$i]['shop_logo'] == ''): ?>
					...
					<div class="cover-content" style="display: none;">
						<a href="SHOP_MAIN/shop/shopindex?shop_id=<?php echo $shop_list[$i]['shop_id']; ?>" class="enter"
							target="_blank">点击进入</a></div>
				<?php else: ?>
					<img alt="虚位以待" src="__TEMP__/<?php echo $style; ?>/public/images/default/default_shop_phantom.svg"/>
					<div class="black-cover" style="display: none;"></div>
					<div class="cover-content" style="display: none;">
						<a href="SHOP_MAIN/shop/applyindex" class="enter"
							target="_blank">点击进入</a></div>
				<?php endif; ?>
				</li>
			<?php } ?>
	...
	<?php endif; ?>
		...
		<?php if(is_array($recommend_detail['goods_list']) || $recommend_detail['goods_list'] instanceof \think\Collection || $recommend_detail['goods_list'] instanceof \think\Paginator): if( count($recommend_detail['goods_list'])==0 ) : echo "" ;else: foreach($recommend_detail['goods_list'] as $key=>$goods_list): ?>
			<li>
				<dl>
					<dt class="goods-name">
						<a title="<?php echo $goods_list['goods_info']['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods_list['goods_info']['goods_id']; ?>" target="_blank"><?php echo $goods_list['goods_info']['goods_name']; ?></a>
					</dt>
					<dd class="goods-thumb">
						<a title="<?php echo $goods_list['goods_info']['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods_list['goods_info']['goods_id']; ?>" target="_blank">
			...
			if(data != '' ){
				if(data[0]['adv_image'] == ""){
					...
					for(var i=0;i<data.length;i++){
						...
						listhtml+='<img class="lazy" src="__UPLOAD__/'+data[i]['adv_image']+'" style="display: inline;height:140px;width:240px;max-width:100%;">';
						listhtml+='</a></div>';
					}
...
<!-- 						分类推荐 -->
							<?php if(is_array($vo['category_list']) || $vo['category_list'] instanceof \think\Collection || $vo['category_list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['category_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
								<li><a href="SHOP_MAIN/goods/goodslist?category_id=<?php echo $item['category_id']; ?>" target="_blank" title="<?php echo $item['category_name']; ?>"><?php echo $item['category_name']; ?></a></li>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					</div>
					...
					<div class="floor-right">
						...
						<?php if(is_array($vo['goods_list_1']) || $vo['goods_list_1'] instanceof \think\Collection || $vo['goods_list_1'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($vo['goods_list_1']) ? array_slice($vo['goods_list_1'],0,6, true) : $vo['goods_list_1']->slice(0,6, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?>
							<div class="item">
								<div class="wrap">
									<a target="_blank" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $good['goods_id']; ?>" title="<?php echo $good['goods_name']; ?>">
										<img class="lazy" src="__UPLOAD__/<?php echo $good['picture_detail']['pic_cover_big']; ?>" />
									</a>
									<p class="title">
										<a target="_blank" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $good['goods_id']; ?>" title="<?php echo $good['goods_name']; ?>"><?php echo $good['goods_name']; ?></a>
									</p>
									<p class="price">
						...
						<div class="brand">
							<div class="brand-con">
								<ul class="brand-list" style="position: absolute;height: 40px;top:0;left:0;">
									...
									<li class="fore1">
										<a href="SHOP_MAIN/goods/goodslist?brand_id=<?php echo $item['brand_id']; ?>" target="_blank" title="<?php echo $item['brand_name']; ?>">
