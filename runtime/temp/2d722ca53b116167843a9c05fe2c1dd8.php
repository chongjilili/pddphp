<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:41:"template/admin\Promotion\mansongList.html";i:1503110755;s:24:"template/admin\base.html";i:1503110755;s:41:"template/admin\controlCommonVariable.html";i:1500286982;s:30:"template/admin\pageCommon.html";i:1500286981;s:30:"template/admin\openDialog.html";i:1500286981;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
			...
			<table>
				<thead>
					<tr align="center">
						...
						<?php if($operate_config->is_mansong_toExamine == 1): ?>
						<th class="tal">审核状态</th>
						<?php endif; ?>
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data["data"].length > 0) {
					//alert(JSON.stringify(data['examine_mansong_status']));
					for (var i = 0; i < data["data"].length; i++) {
						...
						switch(data['data'][i]['examine_status']){
						case 0:
							var examine_status_name = '待审核';
							break;
						case 1:
							var examine_status_name = '审核通过';
							break;
						case 2:
							var examine_status_name = '已拒绝';
							break;
						...
						if(data['examine_mansong_status'] = 1){
							html += '<td class="tal">'+ examine_status_name +'</td>';
						}
