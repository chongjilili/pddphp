<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform\Promotion\mansonginfo.html";i:1503110755;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="padder-v">
		<form class="form-horizontal">
			<section class="panel panel-default">
				<header class="panel-heading font-bold"> 活动信息 </header>
				<div class="panel-body">
					<form class="form-horizontal">
						<div class="form-group">
							<label class="col-md-2 control-label">活动名称：</label>
							<div class="col-md-4">
								<p class="form-control-static"><?php echo $mansong['mansong_name']; ?></p>
							</div>
							<label class="col-md-2 control-label">活动状态：</label>
							<?php if($mansong['status'] == 0): ?>
							<div class="col-md-4">
								<p class="form-control-static">未发布</p>
							</div>
							<?php elseif($mansong['status'] == 1): ?>
							<div class="col-md-4">
								<p class="form-control-static">正常</p>
							</div>
							<?php elseif($mansong['status'] == 3): ?>
							<div class="col-md-4">
								<p class="form-control-static">关闭</p>
							</div>
							<?php elseif($mansong['status'] == 4): ?>
							<div class="col-md-4">
								<p class="form-control-static">结束</p>
							</div>
							<?php endif; ?>
							<label class="col-md-2 control-label">审核状态：</label>
							<?php if($mansong['examine_status'] == 0): ?>
							<div class="col-md-4">
								<p class="form-control-static" style="color:#ff5400;">待审核</p>
							</div>
							<?php elseif($mansong['examine_status'] == 1): ?>
							<div class="col-md-4">
								<p class="form-control-static" style="color:#ff5400;">已通过</p>
							</div>
							<?php elseif($mansong['examine_status'] == 2): ?>
							<div class="col-md-4">
								<p class="form-control-static" style="color:#ff5400;">已拒绝</p>
							</div>
							<?php endif; ?>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<p class="form-control-static"><?php echo $mansong['start_time']; ?></p>
							</div>
							<label class="col-md-2 control-label">活动结束时间：</label>
							<div class="col-md-4">
								<p class="form-control-static"><?php echo $mansong['end_time']; ?></p>
							</div>
							<label class="col-md-2 control-label">店铺名称：</label>
							<div class="col-md-4">
								<p class="form-control-static"><?php echo $mansong['shop_name']; ?></p>
							</div>
							<label class="col-md-2 control-label">创建时间：</label>
							<div class="col-md-4">
								<p class="form-control-static"><?php echo $mansong['create_time']; ?></p>
							</div>
