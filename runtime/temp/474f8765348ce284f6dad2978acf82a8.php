<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"template/platform\Config\paymentConfig.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
				...
				<?php if(is_array($pay_list) || $pay_list instanceof \think\Collection || $pay_list instanceof \think\Paginator): $i = 0; $__LIST__ = $pay_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pay_obj): $mod = ($i % 2 );++$i;?>
					<tr>
					     ...
					     <?php if($pay_obj['is_use'] == 1): ?>
					     	<td style="text-align: center;line-height:59px;"><a href="javascript:;" class="pay-start" status =1 onclick="set_status('<?php echo $pay_obj['key']; ?>', this)"><img src="__ROOT__/public/admin/images/start.png" /></a></td>
					     <?php else: ?>
					     	<td style="text-align: center;line-height:59px;"><a href="javascript:;" class="pay-close" status =0 onclick="set_status('<?php echo $pay_obj['key']; ?>', this)"><img src="__ROOT__/public/admin/images/close.png" /></a></td>
						 <?php endif; ?>					     	
					     <td style="text-align: center;line-height:59px;">
					     	<?php if($pay_obj['key'] == 'WPAY'): ?>
					  			<a href="PLATFORM_MAIN/config/payconfig?type=wchat#wpay">配置</a>
					  		<?php else: ?>
					  			<a href="PLATFORM_MAIN/config/payaliconfig">配置</a>
							<?php endif; ?>					  		  
					  	</td>
					</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
