...
<div class="ncsc-form-goods">
	...
	<dl>
		...
		<dd>
			<div class="controls">
				<input type="number" id="txtGroupPrice" min="0" placeholder="0" value="<?php echo $goods_info['group_price']; ?>" style="width:114px;"/><em class="add-on">元</em>
				<span class="help-inline">商品成本不能为空且需是数字</span>
			</div>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<div class="controls">
				<input type="number" id="txtGroupNum" min="0" placeholder="0" value="<?php echo $goods_info['group_num']; ?>" style="width:114px;"/><em class="add-on">元</em>
				<span class="help-inline">商品成本不能为空且需是数字</span>
			</div>
		</dd>
	</dl>
