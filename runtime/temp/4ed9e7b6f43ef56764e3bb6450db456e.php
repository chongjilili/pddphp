<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform\Config\payAliConfig.html";i:1503114793;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
...
<!-- 								<div class="col-md-4"> -->
<!-- 									<label class="switch"> -->
<!-- 										<input type="checkbox" id="wpay_is_use" <?php if($weixin_config['is_use'] == 1): ?>checked<?php endif; ?>> -->
<!-- 										<span></span> -->
<!-- 									</label> -->
<!-- 								</div> -->
<!-- 							</div> -->
...
<!-- 										value="<?php echo $weixin_config['oauth_value']['appid']; ?>"> -->
<!-- 								</div> -->
...
<!-- 										value="<?php echo $weixin_config['oauth_value']['appkey']; ?>"> -->
<!-- 								</div> -->
...
<!-- 										value="<?php echo $weixin_config['oauth_value']['mch_key']; ?>"> -->
<!-- 								</div> -->
...
<!-- 										value="<?php echo $weixin_config['oauth_value']['mch_id']; ?>"> -->
<!-- 								</div> -->
					...
					<div class="panel-body">
						<form class="form-horizontal" id="alipay_form">
							<div class="form-group">
								...
								<div class="col-md-4">
									<label class="switch">
										<input type="checkbox" id="alipay_is_use" <?php if($config['is_use'] == 1): ?>checked<?php endif; ?>>
										<span></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
								<input type="text" class="form-control" id="ali_seller" required value="<?php echo $config['value']['ali_seller']; ?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="ali_partnerid" required
										value="<?php echo $config['value']['ali_partnerid']; ?>">
							...
							<div class="line line-dashed line-lg pull-in"></div>
							<div class="form-group">
								<label class="col-lg-2 control-label">安全校验码</label>
								<div class="col-md-4">
								<input type="text" class="form-control" id="ali_key" required value="<?php echo $config['value']['ali_key']; ?>">
...
<!-- 								<div class="col-md-4"> -->
<!-- 									<label class="switch"> -->
<!-- 										<input type="checkbox" id="ypay_is_use" <?php if($other_config['oauth_value']['is_balance_pay'] == 1): ?>checked<?php endif; ?>> -->
<!-- 										<span></span> -->
<!-- 									</label> -->
<!-- 								</div> -->
<!-- 							</div> -->
...
<!-- 								<div class="col-md-4"> -->
<!-- 									<label class="switch"> -->
<!-- 										<input type="checkbox" id="gpay_is_use" <?php if($other_config['oauth_value']['is_coin_pay'] == 1): ?>checked<?php endif; ?>> -->
<!-- 										<span></span> -->
<!-- 									</label> -->
<!-- 								</div> -->
<!-- 							</div> -->
 ...
 */
	function setWpayConfigAjax() {
		...
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/Config/setWpayConfig",
			data : {
				'appkey' : appkey,
				'appsecret' : appsecret,
 ...
 */
	function setAliPayConfigAjax(){
		...
		$.ajax({
			type:"post",
			url:"PLATFORM_MAIN/Config/payAliConfig",
			data:{
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', data["message"],'PLATFORM_MAIN/Config/payAliconfig.html');
				}else{
					showMessage('error', data["message"]);
				}	
			}
