<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"template/wap\default\\Order\myOrderList.html";i:1500286963;s:30:"template/wap\default\base.html";i:1500286964;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	        				...
	        				for(var j=0;j<ordersitem['order_item_list'].length;j++){
	        					...
	        					if(ordersitem['payment_type']==4){
	        						if(ordersitem['is_refund']==1 && goodsitem['refund_status']==0 && ordersitem['order_status']==2){
		        						datahtml+='<input type="button" onclick="window.location.href=\'APP_MAIN/Order/refundDetail?order_goods_id='+goodsitem['order_goods_id']+'\'" style="-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;border-radius:3px;border:1px solid red;color:#F37872;background-color:white;font-size: 12px;padding:5px 10px 5px 10px;" value="退款/退货" />';
	        						}
	        					}else{
