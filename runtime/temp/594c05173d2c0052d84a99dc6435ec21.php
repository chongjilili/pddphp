<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"template/platform\Config\loginwchatconfig.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
...
<section class="panel panel-default">
   ...
   <header class="panel-heading text-right bg-light">
     <ul class="nav nav-tabs pull-left">
       <li class=""><a href="#weixin" data-toggle="tab">微信登录</a></li>
     </ul>
     ...
     <div class="panel-body">
          <div class="tab-content">
                     ...
                     <div class="tab-pane fade active in" id="weixin">
						<div class="panel-body">
							<form class="form-horizontal" method="get">
								<div class="form-group">
									...
									<div class="col-md-4">
										<label class="switch">
											<input type="checkbox" id="is_use" <?php if($wchat_config['is_use']=='1'): ?>checked="checked"<?php endif; ?>>
											<span></span>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" id="APP_KEY" value="<?php echo $wchat_config['value']['APP_KEY']; ?>">
									</div>
								</div>
								<div class="line line-dashed line-lg pull-in"></div>
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" class="form-control" id="APP_SECRET" value="<?php echo $wchat_config['value']['APP_SECRET']; ?>">
									</div>
								</div>
					            <div class="line line-dashed line-lg pull-in"></div>
					            <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <p class="form-control-static"><?php echo $wchat_config['value']['AUTHORIZE']; ?></p>
                                    </div>
                                </div>
					            <div class="line line-dashed line-lg pull-in"></div>
					            <div class="form-group">
                                   ...
                                   <div class="col-lg-10">
                                       <p class="form-control-static"><?php echo $wchat_config['value']['CALLBACK']; ?></p>
                                   </div>
                               </div>
								<div class="line line-dashed line-lg pull-in"></div>
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-2">
										...
										<a href="javascript:void(0);" onclick="setWeixinConfigAjax()" class="btn btn-primary">保存</a>
									</div>
								</div>
							</form>
						</div>
                     ...
                     <script>
							function setWeixinConfigAjax(){
								...
								$.ajax({
									type:"post",
									url:"PLATFORM_MAIN/config/loginweixinconfig",
									data:{
										'appkey':appkey,
										'appsecret':appsecret,
										'url':url,
									...
									success:function (data) {
										if (data["code"] > 0) {
											showMessage('success', data["message"],'PLATFORM_MAIN/config/loginwchatconfig');
										}else{
