<?php if (!defined('THINK_PATH')) exit(); /*a:19:{s:40:"template/shop\blue\\Goods\goodsList.html";i:1500287003;s:28:"template/shop\blue\base.html";i:1500287003;s:45:"template/shop\blue\controlCommonVariable.html";i:1500287009;s:34:"template/shop\blue\controlTop.html";i:1500286999;s:41:"template/shop\blue\controlHeadSerach.html";i:1500287009;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1500287009;s:43:"template/shop\blue\controlHeadGoodType.html";i:1500287009;s:40:"template/shop\blue\controlCommonNav.html";i:1500287009;s:43:"template/shop\blue\controlRightSidebar.html";i:1500287003;s:60:"template/shop\blue\Goods\controlGoodsCategoryConditions.html";i:1500287003;s:46:"template/shop\blue\Goods\controlGoodsLeft.html";i:1500287003;s:45:"template/shop\blue\Goods\controlGoodList.html";i:1500287003;s:59:"template/shop\blue\Goods\controlPopUpGoodsSkuAttribute.html";i:1500287003;s:41:"template/shop\blue\controlCommonPage.html";i:1500287009;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1500287009;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1500287009;s:37:"template/shop\blue\controlBottom.html";i:1500287002;s:36:"template/shop\blue\controlLogin.html";i:1500287003;s:37:"template/shop\blue\baidu_js_push.html";i:1500287009;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="w1210">
	<div class="breadcrumb clearfix">
		...
		<?php if(is_array($category_name)): foreach($category_name as $vo): ?>
				&nbsp;&gt;&nbsp;<a href="SHOP_MAIN/goods/goodslist?category_id=<?php echo $vo['category_id']; ?>"><?php echo $vo['category_name']; ?></a>
			<?php endforeach; else: ?>
...
<!-- <form action="" method="post" name="theForm"> -->
	...
	<div class="search-wrap" id="attr-list-ul" style="border-top: none;">
		<!--已选条件-->
		<?php if($brand_name!='' || $min_price!=''|| count($attr_array) > 0): ?>
		<dl class="selected-attr-dl" style="border-bottom: none;">
			<dt>已选条件：</dt>
			<dd class="moredd">
				<a href="SHOP_MAIN/goods/goodslist?category_id=<?php echo $category_id; ?>">全部撤销</a>
			</dd>
			<dd>
				<ul class="selected-attr">
					<!-- 以选择的筛选属性、品牌、价格 -->
					<?php if($brand_name!=''): ?>
					<li><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_brand; ?>" >品牌：<b class="color"><?php echo $brand_name; ?></b><i>×</i></a></li>
					<?php endif; if($max_price!=''): ?>
					<li><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_price; ?>" >价格：<b class="color"><?php echo $min_price; ?>-<?php echo $max_price; ?></b><i>×</i></a></li>
					<?php endif; ?>
					<!-- 取消属性 -->
					<?php if(is_array($attr_array) || $attr_array instanceof \think\Collection || $attr_array instanceof \think\Paginator): if( count($attr_array)==0 ) : echo "" ;else: foreach($attr_array as $key=>$attr_item_vo): ?>
						<li><a onclick="removeAttr(this);"data-attr-value="<?php echo $attr_item_vo[0]; ?>"data-attr-value-name="<?php echo $attr_item_vo[1]; ?>"><?php echo $attr_item_vo[0]; ?>：<b class="color"><?php echo $attr_item_vo[1]; ?></b><i>×</i></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</dd>
		</dl>
				...
				<dd>
					...
					<div id="brand-abox-father">
						<ul class="brand-abox-imgul" style="overflow: hidden;">
							...
							<li class="brand <?php if($k >= 9): ?> overli hide<?php endif; ?>" title="<?php echo $value; ?>" data-attr = "attr<?php echo $key; ?>" data-attr-value="<?php echo $vo['attr_value_name']; ?>" data-attr-value-name="<?php echo $value; ?>" onclick="attrSelect(this);">
								<a href="javascript:;" >
								<?php echo $value; ?>
		...
		<dl>
			...
			<dd>
				<ul>
					...
					<li><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter; ?>&min_price=<?php echo $price_grades[0]; ?>&max_price=<?php echo $price_grades[1]; ?>"><?php echo $price_grades[0]; ?>&nbsp;-&nbsp;<?php echo $price_grades[1]; ?></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
					 <li>
...
<!-- 					<?php endif; ?> -->
					<div class="p-img">
						<a target="_blank" title="<?php echo $goodsinfo['goods_info']['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goodsinfo['goods_id']; ?>"> 
							<img src="__UPLOAD__/<?php echo $goodsinfo['picture_info']['pic_cover_mid']; ?>" />
						</a>
					</div>
					<div class="p-name">
						<a target="_blank" title="<?php echo $goodsinfo['goods_info']['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goodsinfo['goods_id']; ?>"><?php echo $goodsinfo['goods_info']['goods_name']; ?></a>
					</div>
					<div class="p-price">
...
<!-- 					<div class="sell-out"></div> -->
					<?php endif; ?>
					<div class="p-img">
						<a target="_blank" title="<?php echo $goodsinfo['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goodsinfo['goods_id']; ?>">
							<img src="__UPLOAD__/<?php echo $goodsinfo['pic_cover_mid']; ?>" >
						</a>
					</div>
					<div class="p-name">
						<a target="_blank" title="<?php echo $goodsinfo['goods_name']; ?>" href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goodsinfo['goods_id']; ?>"><?php echo $goodsinfo['goods_name']; ?></a>
					</div>
					<div class="p-price">
...
<div class="main">
		...
		<form method="get" name="listform" action="" style="position: relative;">
			<div class="fore1">
				...
				<?php if($order==''): ?><dd class="first curr"><?php else: ?><dd><?php endif; ?>
					<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>">综合</a>
					</dd>
				<!-- 销量 -->
				<?php if($order=='ng.sales'): ?>
					<dd class="curr">
					<?php if($sort=='asc'): ?>
						<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.sales&sort=desc<?php echo $attr_url; ?>">销量
						<b style="background-position:-23px -169px"></b>
					<?php else: ?>
						<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.sales&sort=asc<?php echo $attr_url; ?>">销量
				...
				<?php if($order=='ng.is_new'): ?>
					<dd class="curr">
						<?php if($sort=='asc'): ?>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.is_new&sort=desc<?php echo $attr_url; ?>">新品
							<b style="background-position:-23px -169px"></b>
						<?php else: ?>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.is_new&sort=asc<?php echo $attr_url; ?>">新品
							<b class="icon-order-DESCending"></b>
						<?php endif; else: ?>
						<dd>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.is_new&sort=desc<?php echo $attr_url; ?>">新品
				...
				<?php if($order=='ng.price'): ?>
					<dd class="curr">
						<?php if($sort=='asc' && $order=='ng.price'): ?>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.price&sort=desc<?php echo $attr_url; ?>">价格
							<b style="background-position:-23px -169px"></b>
							
						<?php else: ?>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.price&sort=asc<?php echo $attr_url; ?>">价格
							<b class="icon-order-DESCending"></b>
						<?php endif; else: ?>
					<dd>
							<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_order; ?>&order=ng.price&sort=desc<?php echo $attr_url; ?>">价格
			 ...
			 <div class="fore2">
				<div class="filter-btn">
					...
					<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_shipping; ?><?php echo $attr_url; ?>" class="filter-tag curr">
					<?php else: ?>
					<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter; ?>&shipping_fee=0<?php echo $attr_url; ?>" class="filter-tag ">
					<?php endif; ?>
						<i class="icon" ></i><span class="text">包邮</span>
					</a>
					
					<?php if($stock !='' && $stock>=0): ?>
					<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_stock; ?><?php echo $attr_url; ?>" class="filter-tag curr">
					<?php else: ?>
					<a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter; ?>&stock=0<?php echo $attr_url; ?>" class="filter-tag ">
					<?php endif; ?>
			...
			<ul class="options">
				<div class="filter-detailc" id="addressDraw">
					<dl class="location-hots">
						<dt>常用地区</dt>
						<dd><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=1&province_name=北京<?php echo $attr_url; ?>">北京</a></dd>
						<dd><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=2&province_name=天津<?php echo $attr_url; ?>">天津</a></dd>
						<dd><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=9&province_name=上海<?php echo $attr_url; ?>">上海</a></dd>
					</dl>
						...
						<dd>
							<ul>
								<li>
									<p class="lt">A</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=12&province_name=安徽<?php echo $attr_url; ?>">安徽</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=33&province_name=澳门<?php echo $attr_url; ?>">澳门</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">C</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=22&province_name=重庆<?php echo $attr_url; ?>">重庆</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">F</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=13&province_name=福建<?php echo $attr_url; ?>">福建</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">G</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=19&province_name=广东<?php echo $attr_url; ?>">广东</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=28&province_name=甘肃<?php echo $attr_url; ?>">甘肃</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=20&province_name=广西<?php echo $attr_url; ?>">广西</a></span> 
							...
							<ul>
								<li>
									<p class="lt">H</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=21&province_name=海南<?php echo $attr_url; ?>">海南</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=3&province_name=河北<?php echo $attr_url; ?>">河北</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=16&province_name=河南<?php echo $attr_url; ?>">河南</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=8&province_name=黑龙江<?php echo $attr_url; ?>">黑龙江</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=17&province_name=湖北<?php echo $attr_url; ?>">湖北</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=18&province_name=湖南<?php echo $attr_url; ?>">湖南</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">J</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=10&province_name=江苏<?php echo $attr_url; ?>">江苏</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=14&province_name=江西<?php echo $attr_url; ?>">江西</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=7&province_name=吉林<?php echo $attr_url; ?>">吉林</a></span> 
									</p>
								</li>
							</ul>
							<ul>
								<li>
									<p class="lt">N</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=6&province_name=辽宁<?php echo $attr_url; ?>">辽宁</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=5&province_name=内蒙古<?php echo $attr_url; ?>">内蒙古</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=30&province_name=宁夏<?php echo $attr_url; ?>">宁夏</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">Q</p>
									<p class="lc"> <span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=29&province_name=青海<?php echo $attr_url; ?>">青海</a></span> </p>
								</li>
								<li>
									<p class="lt">S</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=15&province_name=山东<?php echo $attr_url; ?>">山东</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=4&province_name=山西<?php echo $attr_url; ?>">山西</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=27&province_name=陕西<?php echo $attr_url; ?>">陕西</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=23&province_name=四川<?php echo $attr_url; ?>">四川</a></span> 
									</p>
								</li>
							</ul>
							<ul>
								<li>
									<p class="lt">T</p>
									<p class="lc"> <span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=34&province_name=台湾<?php echo $attr_url; ?>">台湾</a></span> </p>
								</li>
								<li>
									<p class="lt">X</p>
									<p class="lc"> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=26&province_name=西藏<?php echo $attr_url; ?>">西藏</a></span> 
										<span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=31&province_name=新疆<?php echo $attr_url; ?>">新疆</a></span> <span><a href="">香港</a></span> 
									</p>
								</li>
								<li>
									<p class="lt">Y</p>
									<p class="lc"> <span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=25&province_name=云南<?php echo $attr_url; ?>">云南</a></span> </p>
								</li>
								<li>
									<p class="lt">Z</p>
									<p class="lc"> <span><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?>&province_id=11&province_name=浙江<?php echo $attr_url; ?>">浙江</a></span> </p>
								</li>
							</ul>
						</dd>
					</dl>
					<p class="oreder-default"><a href="SHOP_MAIN/goods/goodslist?<?php echo $url_parameter_not_province_id; ?><?php echo $attr_url; ?>">不限地区</a></p>
				</div>
			</ul>
		</form>
	</div>
	...
	<form name="compareForm" action="compare.php" method="post" onsubmit="" id="table_list">
		...
		<?php if(is_array($goods_list['data']) || $goods_list['data'] instanceof \think\Collection || $goods_list['data'] instanceof \think\Paginator): if( count($goods_list['data'])==0 ) : echo "" ;else: foreach($goods_list['data'] as $key=>$goods): ?> 
			<ul class="clearfix">
				<li class="thumb">
					<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>">
						<img src="__UPLOAD__/<?php echo $goods['pic_cover_mid']; ?>" class="pic_img_206" style="display: inline;">
					</a>
				</li>
				<li class="goodsName">
					<a href="SHOP_MAIN/shop/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></a>
				</li>
		...
		<ul class="list-grid clearfix js-list-grid">
			...
			<li class="item <?php if($k != 0 && ($k+1)%4==0): ?>last<?php endif; ?>">
				<div class="item-con">
					<div class="item-pic">
						<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" title="<?php echo $goods['goods_name']; ?>" target="_blank">
					...
					<div class="item-info">
						...
						<div class="item-name"><a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>" target="_blank" title="<?php echo $goods['goods_name']; ?>"><?php echo $goods['goods_name']; ?></a></div>
						<div class="item-con-info">
							<div class="fl">
								<div class="item-operate">
									...
									<a href="SHOP_MAIN/goods/goodsinfo?goodsid=<?php echo $goods['goods_id']; ?>#goods_evaluate" target="_blank" class="operate-btn comment-btn"><i></i> <?php echo $goods['evaluates']; ?></a>
								</div>
							</div>
							<div class="fr">
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_11632__=1;$__FOR_END_11632__=$page_count+1;for($i=$__FOR_START_11632__;$i < $__FOR_END_11632__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_25523__=1;$__FOR_END_25523__=$page_num+1;for($i=$__FOR_START_25523__;$i < $__FOR_END_25523__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_19746__=$page_count-$page_num+1;$__FOR_END_19746__=$page_count+1;for($i=$__FOR_START_19746__;$i < $__FOR_END_19746__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_19181__=$page-($page_num-1)/2;$__FOR_END_19181__=$page+($page_num-1)/2+1;for($i=$__FOR_START_19181__;$i < $__FOR_END_19181__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="SHOP_MAIN/<?php echo $path_info; ?>?page=<?php echo $i; ?><?php echo $query_string; ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
