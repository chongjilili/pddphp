...
<div class="row padder-v">
	<div class="col-sm-9 m-b-xs">
		<a href="PLATFORM_MAIN/config/addplatformadv?ap_id=<?php echo $ap_id; ?>"
            ...
            buttons: {
                "确定": function() {
                    ...
                    $.ajax({
            			...
            			success : function(data) {
            				if(data["code"] > 0 ){
            					showMessage('success', data["message"],'PLATFORM_MAIN/config/platformadvlist?ap_id=<?php echo $ap_id; ?>');
            				}else{
