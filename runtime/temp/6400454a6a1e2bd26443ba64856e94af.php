<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"template/platform\Config\updateShopNavigation.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal" method="get">
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="nav_title" value="<?php echo $data['nav_title']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="sort" value="<?php echo $data['sort']; ?>">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-md-6">
					<label for="url_type1" style="margin-top: 5px;margin-left: 10px;">
       					 <input type="radio" value="0" name="url_type" id="url_type1"  <?php if($data['nav_type'] == 0): ?>checked<?php endif; ?>/>
       					 商城模块
       			    </label>
       			    <label for="url_type2" style="margin-top: 5px;">
       			    	<input type="radio" value="1" name="url_type" id="url_type2" <?php if($data['nav_type'] == 1): ?>checked<?php endif; ?>/>
       			                    自定义链接
       			    </label>
<!-- 					<input type="radio" class="form-control" id="nav_url" value=""> -->
				</div>
				<div class="col-md-6">
					<select name="" id="shopNavModel" style="margin-left: 200px;margin-top: 11px;width:178px;border-color:#d9d9d9;color:#999;height:30px;<?php if($data['nav_type'] != 0): ?>display: none;<?php endif; ?>">
			          ...
			          <?php if(!(empty($shopNavTemplate) || (($shopNavTemplate instanceof \think\Collection || $shopNavTemplate instanceof \think\Paginator ) && $shopNavTemplate->isEmpty()))): if(is_array($shopNavTemplate) || $shopNavTemplate instanceof \think\Collection || $shopNavTemplate instanceof \think\Paginator): if( count($shopNavTemplate)==0 ) : echo "" ;else: foreach($shopNavTemplate as $key=>$vo): ?>
			            <option value="<?php echo $vo['template_url']; ?>" <?php if($data['nav_url'] == $vo['template_url']): ?>selected<?php endif; ?>><?php echo $vo['template_name']; ?></option>
			            <?php endforeach; endif; else: echo "" ;endif; endif; ?>
			       </select>
			       <span style="margin-left: 200px;<?php if($data['nav_type'] != 1): ?>display: none;<?php endif; ?>" id="nav_url">
			          <input  type="text"  value="<?php echo $data['nav_url']; ?>" name="nav_url" style="width:210px;height:30px;margin-top:11px;"/>
			...
			<div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <label class="checkbox-inline">
                         <input type="radio" name="type" id="type1" value="1" <?php if($data['type'] == 1): ?>checked<?php endif; ?>> 头部 </label>
                     <label class="checkbox-inline">
                         <input type="radio" name="type" id="type2" value="2" <?php if($data['type'] == 2): ?>checked<?php endif; ?>> 中部 </label>
                     <label class="checkbox-inline">
                         <input type="radio" name="type" id="type3" value="3" <?php if($data['type'] == 3): ?>checked<?php endif; ?>> 底部 </label>
                 </div>
            </div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <label class="checkbox-inline">
                         <input type="radio" value="1" name="is_blank" id="is_blank1" <?php if($data['is_blank'] == 1): ?>checked=""<?php endif; ?>/> 是 
                     </label>
                     <label class="checkbox-inline">
                         <input type="radio" value="0" name="is_blank" id="is_blank2" <?php if($data['is_blank'] == 0): ?>checked=""<?php endif; ?> /> 否 
                     </label>
                 </div>
            </div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<input type="hidden" id="nav_id" value="<?php echo $data['nav_id']; ?>">
