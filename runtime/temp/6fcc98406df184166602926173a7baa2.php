<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"template/admin\Promotion\getDiscountList.html";i:1503110755;s:24:"template/admin\base.html";i:1503110755;s:41:"template/admin\controlCommonVariable.html";i:1500286982;s:30:"template/admin\pageCommon.html";i:1500286981;s:30:"template/admin\openDialog.html";i:1500286981;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
			...
			<table>
				<thead>
					<tr align="center">
						...
						<?php if($operate_config->is_discount_toExamine == 1): ?>
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					if(data['examine_discount_status'] = 1){
