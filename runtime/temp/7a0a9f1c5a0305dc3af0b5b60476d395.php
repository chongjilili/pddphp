<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"template/wap\default\\Login\register.html";i:1500286979;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>会员注册<?php if($seoconfig['seo_title'] != ''): ?>-<?php echo $seoconfig['seo_title']; endif; ?></title>
	...
	<div class="reg-box">
		<!-- <form id="regForm" action="APP_MAIN/login/register" method="post" onsubmit="return check()"> -->
			...
			<div id="nk_text1" style="display:block;">
				...
				<div class="nk_loginlogin" style="margin-top:15px;"><a href="APP_MAIN/login/index">已有账号,立即登录</a></div>  
			</div>
			<?php endif; ?>
		<!-- </form> -->
		<!-- <form action="" method="post"> -->
			<?php if(strpos($reg_config['register_info'],'mobile') !== false): if(strpos($reg_config['register_info'],'plain') === false): ?>
				...
				<div class="nk-cont" >
				        ...
				        <img class="verifyimg" style="width:75px!important;float: right;margin: 4px;" src=" <?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>'"  alt="captcha" style="vertical-align: middle; cursor: pointer; height: 35px;" />
				        </label>
				</div>
			   <?php endif; ?>
				<div class="nk-cont">
