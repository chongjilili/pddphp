<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"template/platform\Goods\editGoodsBrand.html";i:1500286957;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal" id="goods_brand_form">
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" class="form-control" id="brand_name" name="brand_name" value="<?php echo $brand_info['brand_name']; ?>" required>
				</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-1">
					<input type="text" class="form-control" id="brand_initial" name="brand_initial" value="<?php echo $brand_info['brand_initial']; ?>" required maxlength="1">
				</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<label class="switch">
                                                    <input id="brand_recommend" type="checkbox" <?php if($brand_info['brand_recommend'] == 1): ?>checked<?php endif; ?>>
                                                    <span></span> </label>
				</div>
			</div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
				...
				<div class="col-sm-2 category_name">
					<span><?php echo $brand_info['category_name']; ?></span>
				...
				<div class="col-sm-2 category_id_1" style="display:none;">
					<select id="category_id_1" name="account" class="form-control m-b" onchange="changeCategory(1)">
						...
						<?php if(is_array($goods_category_list) || $goods_category_list instanceof \think\Collection || $goods_category_list instanceof \think\Paginator): if( count($goods_category_list)==0 ) : echo "" ;else: foreach($goods_category_list as $key=>$v1): ?>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<p>
						<?php if($brand_info['brand_pic'] == ''): ?>
						<img id="imgLogo" class="imglogo" src=""/>
						<?php else: ?>
						<img id="imgLogo" class="imglogo" src="__UPLOAD__/<?php echo $brand_info['brand_pic']; ?>"/>
						<?php endif; ?>
					</p>
                                            	<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $brand_info['brand_pic']; ?>" />
													</span>
            ...
            <div class="form-group">
				...
				<div class="col-md-4">
					<p>
						<?php if($brand_info['brand_ads'] == ''): ?>
						<img id="imgLogo1" class="imglogo" src=""/>
						<?php else: ?>
						<img id="imgLogo1" class="imglogo" src="__UPLOAD__/<?php echo $brand_info['brand_ads']; ?>"/>
						<?php endif; ?>
					</p>
                                            	<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		<span style="width: 97px;height: 34px;position: absolute;left: 0;top: 0;z-index: 2;cursor: pointer;"> 
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo1" value="<?php echo $brand_info['brand_ads']; ?>" />
													</span>
													<a class="btn btn-default"><i class="fa fa-cloud-upload text"></i><span class="text">上传图片</span></a>
												</a>
				</div>
			...
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					<input type="hidden" id="brand_id" value="<?php echo $brand_info['brand_id']; ?>">
...
function changeCategory(type){
	...
	$.ajax({
		type:"post",
		url:"PLATFORM_MAIN/goods/changecategory",
		data:{
			'pid':pid
		},
		async:true,
	...
	function updateGoodsBrandAjax(){
		...
		$.ajax({
			type:"post",
			url:"PLATFORM_MAIN/goods/updategoodsbrand",
			data:{
				'brand_id':brand_id,
			...
			success:function (data) {
				if (data["code"] > 0) {
					showMessage('success', "商品品牌修改成功",'PLATFORM_MAIN/goods/goodsbrandlist');
				}else{
