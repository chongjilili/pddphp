<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"template/platform\Config\updatePlatformAdv.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
	...
	<div class="panel-body">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="adv_title" value="<?php echo $adv_info['adv_title']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<?php if(is_array($platform_adv_position_list) || $platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator): $i = 0; $__LIST__ = $platform_adv_position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['ap_id']; ?>" <?php if($adv_info['ap_id'] == $vo['ap_id']): ?>selected<?php endif; ?>><?php echo $vo['ap_name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-10">
					<p>
					<?php if($adv_info['adv_image'] == ''): ?>
					  <img id="imgLogo" src="" class="imglogo"/>
					<?php else: ?>
					  <img id="imgLogo" src="__UPLOAD__/<?php echo $adv_info['adv_image']; ?>" class="imglogo"/>
					<?php endif; ?>
					</p>
                                            	<a href="javascript:void(0);" style="display:block;position:relative;z-index:1;">
                                            		...
                                            		<input hidefocus="true" size="1" class="input-file" name="file_upload"
														...
														<input type="hidden" id="Logo" value="<?php echo $adv_info['adv_image']; ?>" />
													</span>
            ...
            <div class="form-group">
				...
				<div class="col-md-1">
<!-- 					<input id="colorpicker" value="<?php echo $adv_info['background']; ?>"/> -->
					<input type="color" class="form-control" id="colorpicker" value="<?php echo $adv_info['background']; ?>">
				</div>
			</div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="adv_url" value="<?php echo $adv_info['adv_url']; ?>">
				</div>
			</div>
            <div class="line line-dashed line-lg pull-in"></div>
            <div class="form-group">
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="slide_sort" value="<?php echo $adv_info['slide_sort']; ?>">
				</div>
			</div>
            <div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
				<input type="hidden" id="adv_id" value="<?php echo $adv_info['adv_id']; ?>">
...
$(function (){
	$("#colorpicker").spectrum({
	    color: "<?php echo $adv_info['background']; ?>",
	    showInput: true,
