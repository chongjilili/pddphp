<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"template/admin\Promotion\fullShipping.html";i:1500375843;s:24:"template/admin\base.html";i:1503110755;s:41:"template/admin\controlCommonVariable.html";i:1500286982;s:30:"template/admin\pageCommon.html";i:1500286981;s:30:"template/admin\openDialog.html";i:1500286981;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
				...
				<tr>
					...
					<td>
						<div class="controls">
							...
							<input type="hidden" id="is_open" value='<?php echo $info['is_open']; ?>' />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div>
							<input id="full_mail_money" class="input-mini input-integral" type="number" min="0.01" step="0.01" value="<?php echo $info['full_mail_money']; ?>" />
