<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform\Config\addPlatformAdv.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<?php if(is_array($platform_adv_position_list) || $platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator): $i = 0; $__LIST__ = $platform_adv_position_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['ap_id']; ?>" <?php if($ap_id == $vo['ap_id']): ?>selected<?php endif; ?>><?php echo $vo['ap_name']; ?></option>
					<?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</div>
			</div>
...
//  		verify(ad_image, link_url);
		$.ajax({
			type : "post",
			url : "PLATFORM_MAIN/config/addplatformadv",
			data : {
				'adv_title' : adv_title,
				'ap_id' : ap_id,
				'adv_image' : adv_image,
			...
			success : function(data) {
				if (data["code"] > 0) {
					showMessage('success', "添加成功",'PLATFORM_MAIN/config/platformadvlist?ap_id='+ap_id);
				}else{
