<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"template/platform\Config\seoConfig.html";i:1500286961;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
		...
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="title" value="<?php echo $info['seo_title']; ?>" style="width:30%;">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="meta" value="<?php echo $info['seo_meta']; ?>" style="width:30%;">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<input type="text" class="form-control" id="desc" value="<?php echo $info['seo_desc']; ?>" style="width:30%;">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4" style="width:80%;">
					<textarea style="width:300px;height:100px;border-color:#d9d9d9;" id="other"><?php echo $info['seo_other']; ?></textarea>
				</div>
...
<script>
	...
	function setConfigAjax(){
		...
		$.ajax({
			type:"post",
			url : "PLATFORM_MAIN/config/seoconfig",
			async : true,
			data : {
				"seo_title" : title,
				"seo_meta" : meta,
				...
				if(data['code'] > 0)
					{
						...
						location.href="PLATFORM_MAIN/config/seoconfig";
					}else{
