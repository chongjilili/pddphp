<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:37:"template/admin\Shop\offlineStore.html";i:1503110755;s:24:"template/admin\base.html";i:1503110755;s:41:"template/admin\controlCommonVariable.html";i:1500286982;s:30:"template/admin\pageCommon.html";i:1500286981;s:30:"template/admin\openDialog.html";i:1500286981;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style"  >
	<dl>
		<dt>兑换码生成前缀:</dt>
		<dd>
			<input type="text" id="shop_vrcode_prefix"   value="<?php echo $shop_info['shop_vrcode_prefix']; ?>" maxlength="3"/> 
	...
	<dl>
		<dt>线下商铺名称:</dt>
		<dd>
		<?php if($shop_info['live_store_name'] == ''): ?>
			<input type="text" id="live_store_name"  value="<?php echo $shop_info['shop_name']; ?>" maxlength="30"/> 
		<?php else: ?>
		    <input type="text" id="live_store_name"  value="<?php echo $shop_info['live_store_name']; ?>" maxlength="30"/> 
		<?php endif; ?>
	...
	<dl>
		<dt>线下商铺电话</dt>
		<dd>
		<?php if($shop_info['live_store_tel'] == ''): ?>
			<input type="text" id="live_store_tel" value="<?php echo $shop_info['shop_phone']; ?>" /> 
		<?php else: ?>
		    <input type="text" id="live_store_tel" value="<?php echo $shop_info['live_store_tel']; ?>" /> 
		<?php endif; ?>
	...
	<dl>
		<dt>线下商铺地址</dt>
		<dd>
			<input type="text" id="live_store_address"  value="<?php echo $shop_info['live_store_address']; ?>" /> 
	...
	<dl>
		<dt>线下交通信息:</dt>
		<dd>
			<textarea  rows="2" id="live_store_bus" class="textarea w400" maxlength="50"><?php echo $shop_info['live_store_bus']; ?></textarea>
...
<script src="http://webapi.amap.com/maps?v=1.3&amp;key=2df5711d4e2fd9ecd1622b5a53fc6b1d&callback=init"></script>
		...
		<script type="text/javascript">
			var map = new AMap.Map('map',{
			   zoom: 10,
			   center: [<?php echo $shop_info['latitude_longitude']; ?>]
// 			   center: [116.39,39.9]	
