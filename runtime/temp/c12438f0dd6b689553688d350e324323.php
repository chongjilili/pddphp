<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"template/platform\Cms\articleClassList.html";i:1500286958;s:27:"template/platform\base.html";i:1500286957;s:44:"template/platform\controlCommonVariable.html";i:1500286961;s:33:"template/platform\openDialog.html";i:1500286958;}*/ ?>
<!DOCTYPE html>
...
<section class="panel panel-default">
	<table class="table table-striped b-t b-light text-sm">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
			<tr class="pid_0">
				<td><?php if($v['child_list'] != array()): ?><a
					href="javascript:;" onclick="tab_switch(<?php echo $v['class_id']; ?>)"
					class="tab_jia_<?php echo $v['class_id']; ?>" style="display: block;"> <i
						class="fa fa-plus"></i></a> <a href="javascript:;"
					onclick="tab_switch(<?php echo $v['class_id']; ?>)"
					class="tab_jian_<?php echo $v['class_id']; ?>" style="display: none;"><i
						class="fa fa-minus"></i></a> <?php endif; ?>
				</td>
				<td><input type="text" class="form-control"
					fieldid="<?php echo $v['class_id']; ?>" fieldname="sort" value="<?php echo $v['sort']; ?>"
					size="1"></td>
				<td>
					<div class="col-md-12">
					<?php echo $v['name']; ?>
				...
				<td class="center"><a
					href="PLATFORM_MAIN/Cms/updateArticleClass?class_id=<?php echo $v['class_id']; ?>">修改</a>&nbsp;
					<a href="javascript:void(0);"
					onclick="deleteArticleClass(<?php echo $v['class_id']; ?>)">删除</a></td>
			</tr>
			<?php if(is_array($v['child_list']) || $v['child_list'] instanceof \think\Collection || $v['child_list'] instanceof \think\Paginator): if( count($v['child_list'])==0 ) : echo "" ;else: foreach($v['child_list'] as $key=>$v2): ?>
				<tr class="pid_<?php echo $v['class_id']; ?>" style="display: none;">
				<td></td>
				<td><input type="text" class="form-control"
					fieldid="<?php echo $v2['class_id']; ?>" fieldname="sort" value="<?php echo $v2['sort']; ?>"
					size="1"></td>
				<td>
				...
				<td class="center"><a
					href="PLATFORM_MAIN/Cms/updateArticleClass?class_id=<?php echo $v2['class_id']; ?>">修改</a>
					<a href="javascript:void(0);"
					onclick="deleteArticleClass(<?php echo $v2['class_id']; ?>)">删除</a></td>
			</tr>
