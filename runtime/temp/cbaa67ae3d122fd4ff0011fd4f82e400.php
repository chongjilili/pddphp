<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"template/admin\Shop\updatePickupPoint.html";i:1500286984;s:24:"template/admin\base.html";i:1503110755;s:41:"template/admin\controlCommonVariable.html";i:1500286982;s:30:"template/admin\pageCommon.html";i:1500286981;s:30:"template/admin\openDialog.html";i:1500286981;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="name" type="text" value="<?php echo $pickupPoint_detail['name']; ?>"></p>
	...
	<dl>
		...
		<dd>
			<p>
				<select name="province" id="seleAreaNext" onchange="GetProvince();" value="<?php echo $pickupPoint_detail['province_id']; ?>">
					<option value="">请选择省</option>
				</select>
				<select name="city" id="seleAreaThird" onchange="getSelCity();" value="<?php echo $pickupPoint_detail['city_id']; ?>">
					<option value="">请选择市</option>
				</select>
				<select name="district" id="seleAreaFouth" value="<?php echo $pickupPoint_detail['district_id']; ?>">
	...
	<dl>
		...
		<dd>
			<p><input id="address" type="text" value="<?php echo $pickupPoint_detail['address']; ?>"></p>
	...
	<dl>
		<dt>自提点联系人:</dt>
		<dd>
			<p><input id="contact" type="text" value="<?php echo $pickupPoint_detail['contact']; ?>"></p>
		</dd>
	</dl>
	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;自提点电话:</dt>
		<dd>
			<p><input id="phone" type="text" value="<?php echo $pickupPoint_detail['phone']; ?>"></p>
			<p class="error">自提点电话不能为空</p>
		</dd>
	</dl>
	<input type="hidden" id="provinceid" value="<?php echo $pickupPoint_detail['province_id']; ?>">
	<input type="hidden" id="cityid" value="<?php echo $pickupPoint_detail['city_id']; ?>">
	<input type="hidden" id="districtid" value="<?php echo $pickupPoint_detail['district_id']; ?>">
	<input type="hidden" id="pickip_id" value="<?php echo $pickip_id; ?>"/>
	<button class="edit_button" onclick="updateReturnAjax();">提交</button>
</div>
 <script>
...
// 			}
		...
		$.ajax({
			type : "post",
			url : "ADMIN_MAIN/shop/updatepickuppoint",
			data : {
				'id' :id,
				'name' : name,
				'address' : address,
			...
			success : function(data) {
				if (data['code'] > 0) {
					    showMessage('success', data["message"],window.location.href="ADMIN_MAIN/shop/pickuppointlist");
