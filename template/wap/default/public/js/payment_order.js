 ...
 * 创建时间：2017年6月21日 16:55:15 万域网络
 * 更新时间：2017年6月22日 15:05:03 万域网络
 ...
 * 2、货到付款
 *   配送方式有：1、商家配送（计算运费）
 * 创建时间：2017年6月21日 16:59:25 万域网络
 * 更新时间：2017年6月22日 14:50:57 万域网络
 * 
...
function validationOrder(){
	...
	if(parseInt($(".item-options[data-flag='distribution']").attr("data-select")) == 0){
		if($(".item-options[data-flag='express_company']").attr("data-select") == undefined){
			showBox("商家未配置物流公司");
			// showBox($(".item-options[data-flag='distribution']").attr("data-select"));
			return false;
		}
	}
